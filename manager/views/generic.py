...
from manager.models import Manager, Team, Country, League
from manager.helpers import generate_drivers, generate_staff, generate_car
...
class CreateTeamView(View):
    ...
    def post(self, request):
        ...
        championship = League.objects.get(id=1)
